...
class HockeyTile extends StatelessWidget {
  const HockeyTile({super.key, required this.image1, required this.image2, required this.title, required this.team1, required this.team2, required this.time});
          ...
          children: [
            ...
            Row(
              children: [Container(
                ...
                child: Center(child: Text("MEGA  1.5 Lakhs",style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold,color: Colors.orange),)),
              ), Spacer(), Icon(Icons.notifications_active_outlined,size: 20,)],
            )
          ],
        ),
      ),
